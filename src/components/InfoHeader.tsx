...
export function InfoHeader({
  ...
  const displayAction = action || t("common.details");
  ...
  return (
    <View style={[styles.header, { backgroundColor: palette.background }]}>
      ...
      <View style={styles.breadcrumb}>
        <Text style={[styles.breadcrumbText, { color: palette.breadcrumb }]}>
          {entity}
        </Text>
        <Ionicons name="chevron-forward" size={16} color={palette.breadcrumb} />
        <Text style={[styles.breadcrumbTextActive, { color: palette.accent }]}>
          {displayAction}
        </Text>
      </View>
    </View>
