...
const InfoReserva: React.FC = () => {
    ...
    return (
      ...
      >
        ...
        <View style={[styles.subContainer, { backgroundColor: theme.content }]}>
          <Loading
            message={t("common.loadingReservation")}
  ...
  if (error || !reserva) {
    return (
      ...
      >
        ...
        <View style={[styles.subContainer, { backgroundColor: theme.content }]}>
          <ErrorState
            message={error || t("messages.reservationNotFound")}
            onRetry={loadReserva}
  ...
  return (
    ...
    >
      ...
      <InfoHeader
        entity={t("dashboard.reservations")}
        onBackPress={() => router.back()}
        colors={{
          background: theme.background,
          breadcrumb: theme.breadcrumb,
      ...
      <View style={[styles.subContainer, { backgroundColor: theme.content }]}>
        ...
        >
          ...
          <TitleSection
            title={`${t("reservations.room")} ${withPlaceholder(
              reserva.quartos?.numero_quarto,
              "S/N"
            )}`}
            subtitle={t("reservations.roomNumber")}
            badge={
              <StatusBadge
                text={translateStatus(reserva.status ?? "PENDENTE")}
          ...
          <InfoRow
            ...
            label={t("reservations.checkInDate").toUpperCase()}
          ...
          <InfoRow
            icon="calendar-outline"
            label={t("reservations.checkOutDate").toUpperCase()}
          ...
          <InfoRow
            icon="cash-outline"
            label={t("reservations.totalValue").toUpperCase()}
          ...
          <InfoRow
            icon="people-outline"
            label={t("reservations.numberOfGuests").toUpperCase()}
            value={`${reserva.numero_hospedes || 0} ${
              reserva.numero_hospedes === 1
          ...
          {reserva.observacoes && (
            <InfoRow
              ...
              label={t("reservations.notes").toUpperCase()}
          ...
          {reserva.checkin_realizado_em && (
            <InfoRow
              ...
              label={t("reservations.checkInCompleted").toUpperCase()}
          ...
          {reserva.checkout_realizado_em && (
            <InfoRow
              icon="checkmark-circle-outline"
              label={t("reservations.checkOutCompleted").toUpperCase()}
        ...
        <View style={styles.options}>
          ...
          {reserva.status === "Ativa" && (
            <ActionButton
              ...
              tone={isDarkMode ? "dark" : "light"}
            >
              {t("reservations.confirmCheckOut")}
            </ActionButton>
          )}
        ...
        >
          ...
          >
            ...
            <Text style={[styles.modalMessage, { color: theme.modalText }]}>
              {t("messages.confirmDeleteReservation")}
            </Text>
