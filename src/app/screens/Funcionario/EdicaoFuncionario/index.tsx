...
const EditarFuncionario: React.FC = () => {
  ...
  const cargosDisponiveis: SelectOption[] = useMemo(
    () => [
      ...
      { label: t("employees.positions.valet"), value: "Manobrista" },
  ...
  const handleSelectPhoto = async () => {
    ...
    Alert.alert(
      ...
      t("imagePicker.uploadFeatureComingSoon"),
      [{ text: t("common.ok") }]
    );
  };
  ...
  const handleRemovePhoto = () => {
    Alert.alert(
      t("imagePicker.removePhoto"),
      t("imagePicker.confirmRemovePhoto"),
      [
        { text: t("common.cancel"), style: "cancel" },
        {
          text: t("imagePicker.remove"),
          style: "destructive",
          onPress: () => {
            setPhotoUri(null);
      ...
      <View style={[styles.content, { backgroundColor: theme.content }]}>
        ...
        >
          ...
          <Text style={[styles.subtitle, { color: theme.textSecondary }]}>
            {t("employees.registerNewEmployee")}
          </Text>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.fieldGroup}>
              ...
              <FormInput
                ...
                maxLength={14}
                helperText={t("validation.cpfFormat")}
                isDarkMode={isDarkMode}
              />
            </View>
