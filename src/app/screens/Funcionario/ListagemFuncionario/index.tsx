    ...
    >
      ...
      <View style={styles.cardContent}>
        ...
        <View style={styles.cardFooter}>
          ...
          <Text style={[styles.cardCpf, { color: theme.textSecondary }]}>
            {item.cpf}
          </Text>
        </View>
        {item.cargo && (
          <Text style={[styles.cardCargo, { color: theme.textSecondary }]}>
            {item.cargo}
          </Text>
        )}
      </View>
  ...
  return (
    ...
    >
      ...
      <View style={[styles.topHeader, { backgroundColor: theme.background }]}>
        ...
        <Text style={[styles.headerTitle, { color: theme.backIcon }]}>
          {t("employees.title")}
        </Text>
      </View>
      ...
      <View style={[styles.content, { backgroundColor: theme.content }]}>
        ...
        <View style={styles.header}>
          ...
          <Text style={[styles.subtitle, { color: theme.textSecondary }]}>
            ...
            {filteredItems.length === 1 ? (t("employees.title2")) : t("employees.title")}
          </Text>
        </View>
        ...
        {filteredItems.length > 0 ? (
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={[styles.emptySubtitle, { color: theme.emptyText }]}>
              {search ? t("common.search") : t("employees.newEmployee")}
            </Text>
          </View>
        )}
      </View>
