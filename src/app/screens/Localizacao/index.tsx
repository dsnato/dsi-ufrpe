...
export default function LocalizacaoScreen() {
  ...
  const handleSaveEdit = async () => {
    try {
      ...
      if (existing) {
        ...
        // Insere
        result = await supabase.from("hotel_config").insert([
          {
            nome: dataToSave.nome,
            endereco: dataToSave.endereco,
            cidade: dataToSave.cidade,
      ...
      showSuccess(t("locationPage.infoUpdated"));
    } catch (error: any) {
      console.error("Erro ao salvar:", error);
      showError(`${t("locationPage.updateError")}: ${error.message}`);
    } finally {
      setSaving(false);
    }
  };
  ...
  const openInMaps = () => {
    ...
    Linking.openURL(url).catch(() => {
      Alert.alert(t("common.error"), t("locationPage.cannotOpenMap"));
    });
  };
  ...
  const callHotel = () => {
    ...
    Linking.openURL(`tel:${phoneNumber}`).catch(() => {
      Alert.alert(t("common.error"), t("locationPage.cannotMakeCall"));
    });
  };
          ...
          <View style={[styles.infoCard, { backgroundColor: theme.content }]}>
            ...
            <View style={styles.section}>
              <View style={styles.sectionHeader}>
                ...
                <Text style={[styles.sectionTitle, { color: theme.text }]}>
                  {t("locationPage.phone")}
                </Text>
              </View>
              <Text style={[styles.contactText, { color: theme.iconPrimary }]}>
                {hotelInfo.telefone}
              </Text>
            </View>
            ...
            {/* Info Footer */}
            <View
              style={[styles.infoFooter, { backgroundColor: theme.sectionBg }]}
            >
              <Ionicons
              ...
              />
              <Text
                style={[styles.infoFooterText, { color: theme.textSecondary }]}
              >
                {t("locationPage.tapMarkerInfo")}
              </Text>
            </View>
          </View>
        </ScrollView>
          ...
          >
            ...
            >
              <Text style={[styles.modalTitle, { color: theme.text }]}>
                {t("locationPage.editHotelInfoTitle")}
              </Text>
            ...
            <ScrollView style={styles.modalScroll}>
              <View style={styles.formGroup}>
                ...
                <TextInput
                  ...
                  value={editData.nome}
                  onChangeText={(text) =>
                    setEditData({ ...editData, nome: text })
                  }
                  placeholder={t("locationPage.hotelNamePlaceholder")}
              ...
              <View style={styles.formGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setEditData({ ...editData, endereco: text })
                  }
              ...
              <View style={styles.formRow}>
                <View style={[styles.formGroup, { flex: 2 }]}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      setEditData({ ...editData, cidade: text })
                    }
                    placeholder={t("locationPage.cityPlaceholder")}
                    placeholderTextColor={theme.textSecondary}
                  />
                </View>
                ...
                <View style={[styles.formGroup, { flex: 1 }]}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      setEditData({ ...editData, estado: text })
                    }
                    placeholder={t("locationPage.statePlaceholder")}
                    placeholderTextColor={theme.textSecondary}
                    maxLength={2}
                  />
                </View>
              ...
              <View style={styles.formGroup}>
                ...
                <TextInput
                  ...
                  value={editData.cep}
                  onChangeText={(text) =>
                    setEditData({ ...editData, cep: text })
                  }
                  placeholder={t("locationPage.zipCodePlaceholder")}
                  placeholderTextColor={theme.textSecondary}
              ...
              <View style={styles.formGroup}>
                ...
                <TextInput
                  ...
                  onChangeText={(text) =>
                    setEditData({ ...editData, telefone: text })
                  }
                  placeholder={t("locationPage.phonePlaceholder")}
                  placeholderTextColor={theme.textSecondary}
              ...
              <View
                style={[styles.helperText, { backgroundColor: theme.helperBg }]}
              >
                <Ionicons
                  name="information-circle"
                  size={16}
                ...
                <Text
                  style={[
                    styles.helperTextContent,
                    { color: theme.textSecondary },
                  ]}
                >
                  {t("locationPage.coordinatesHelper")}
                </Text>
              </View>
            </ScrollView>
            ...
            >
              ...
              <ActionButton
                ...
                tone={isDarkMode ? "dark" : "light"}
              >
                {saving ? t("locationPage.saving") : t("locationPage.save")}
              </ActionButton>
            </View>
          </View>
        </View>
