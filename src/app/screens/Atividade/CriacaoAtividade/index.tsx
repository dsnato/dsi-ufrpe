    ...
    try {
      ...
      if (imagemUri && novaAtividade.id) {
        try {
          ...
          console.log(
            "🖼️ [CriacaoAtividade] Image URI length:",
            imagemUri.length
          );

          const imageUrl = await uploadImagemAtividade(
            novaAtividade.id,
            imagemUri
          );
  ...
  return (
    ...
    >
      <InfoHeader
        ...
        entity={t("navigation.activities")}
        ...
        >
          ...
          <View style={styles.titleContainer}>
            ...
            <Text style={[styles.title, { color: theme.text }]}>
              {t("activities.newActivity", "Nova Atividade")}
            </Text>
          </View>
          ...
          <View style={styles.form}>
            ...
            <View style={[styles.fieldGroup, styles.halfWidth]}>
              ...
              <FormInput
                ...
                keyboardType="numeric"
                maxLength={5}
                helperText={t("validation.timeFormat")}
                isDarkMode={isDarkMode}
              />
            </View>
          ...
          <View style={styles.actions}>
            ...
            >
              {loading
                ...
                : t("activities.createActivity", "Criar Atividade")}
            </ActionButton>
