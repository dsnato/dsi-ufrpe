...
const InfoQuarto: React.FC = () => {
  ...
  const confirmDelete = async () => {
    try {
      ...
      showSuccess(t("rooms.deleteSuccess"));
      ...
      showError(
        `${t("rooms.deleteError")}: ${error?.message || t("common.error")}`
      );
      setLoading(false);
    }
  };
    ...
    return (
      ...
      >
        ...
        <View style={[styles.subContainer, { backgroundColor: theme.content }]}>
          <Loading message={t("common.loadingRoom")} isDarkMode={isDarkMode} />
        </View>
      </SafeAreaView>
    );
  }
  ...
  if (error || !quarto) {
    return (
      ...
      >
        ...
        <View style={[styles.subContainer, { backgroundColor: theme.content }]}>
          <ErrorState
            message={error || t("messages.roomNotFound")}
            onRetry={loadQuarto}
    ...
    >
      ...
      <View style={[styles.subContainer, { backgroundColor: theme.content }]}>
        ...
        >
          ...
          <TitleSection
            title={`${t("rooms.roomNumber")} ${withPlaceholder(
              quarto.numero_quarto,
              "S/N"
            )}`}
            subtitle={t("rooms.roomNumberLabel")}
          ...
          <InfoRow
            ...
            value={withPlaceholder(quarto.tipo, t("rooms.typeNotInformed"))}
          ...
          <InfoRow
            ...
            value={`${quarto.capacidade_pessoas || 0} ${
              quarto.capacidade_pessoas === 1
                ? t("rooms.person")
                : t("rooms.people")
            }`}
            iconColor={theme.accent}
