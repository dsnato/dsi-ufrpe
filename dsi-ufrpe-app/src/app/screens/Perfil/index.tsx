...
export default function Perfil() {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            ...
            const name = metadata.display_name || currentSession.user.email?.split("@")[0] || "Usuário";
            const userRole = metadata.profile_role || metadata.role || "Colaborador";
            const savedTheme = metadata.preferred_theme === "dark" ? "dark" : "light";
            const savedHotel = metadata.hotel_name || metadata.nome_hotel || metadata.hotel || "Hotel Atlântico";
                ...
                >
                    <View style={[styles.profileCard, { backgroundColor: theme.card, shadowColor: theme.shadow }]}>
                        ...
                        <View style={styles.metricsContainer}>
                            <Text style={[styles.metricsTitle, { color: theme.text }]}>Destaques</Text>
                    ...
                    <View style={[styles.section, { backgroundColor: theme.card, borderColor: theme.border }]}>
                        ...
                        <View style={styles.preferenceCard}>
                            <View style={styles.preferenceHeader}>
                                ...
                                <View>
                                    <Text style={[styles.preferenceLabel, { color: theme.text }]}>Tema do aplicativo</Text>
                                    <Text style={[styles.preferenceHelper, { color: theme.muted }]}>Defina a paleta ideal para liderar o hotel.</Text>
                                </View>
                            </View>
                            <FormSelect
                                icon="color-palette"
                        ...
                        >
                            ...
                            <Text style={styles.primaryButtonText}>Editar informações básicas</Text>
                        </TouchableOpacity>
                    </View>
                </ScrollView>
            </View>
